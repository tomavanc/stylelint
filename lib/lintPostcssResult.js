...
import getOsEol from './utils/getOsEol.js';
import reportUnknownRuleNames from './reportUnknownRuleNames.js';
import rulesOrder from './rules/index.js';
...
export default lintPostcssResult;
