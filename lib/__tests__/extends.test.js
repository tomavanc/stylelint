...
import configExtendingAnotherExtend from './fixtures/config-extending-another-extend.json' assert { type: 'json' };
import configExtendingOne from './fixtures/config-extending-one.js';
import configExtendingThreeWithOverride from './fixtures/config-extending-three-with-override.js';
